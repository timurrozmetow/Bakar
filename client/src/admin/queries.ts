...
/**
 * Authenticated data hooks for the admin panel.
 *
 * Deliberately kept out of `lib/queries.ts`: these pull in `sonner` for toasts,
 * and the public site — which only needs `useSiteData` — would otherwise ship
 * the toast library to every visitor.
 */
